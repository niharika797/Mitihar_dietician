...
> Business model confirmed: platform takes 2% royalty on ₹1,500 doctor consultations.
...
> Business model: Patient pays doctor ₹1,500 per consultation.
> Platform takes 2% royalty. Split 0.67% × 3 team members. Paid annually.
...
### Patient App — Home Screen
- [x] "Next Visit" card — shows cycle_start + 15 days as follow-up date with color-coded countdown (green/amber/red); wired to existing `GET /patients/my-visit` endpoint; satisfies contract Article II-d and V.1
...
**PHASE 5C SCORE: 18 / 19** — 1 remaining (FCM notification wiring in patient app — blocked on Firebase setup)
...
## 📊 ACCURATE TASK COUNT (2026-04-20, post-contract-gap-fix session)
...
| Phase 5C — Frontend Token Changes | 19 | 18 | 1 (FCM wiring only) |
...
**Overall progress: 231 / 277 = 83% complete**
...
## 🧾 BUSINESS MODEL (Corrected 2026-04-20 — per signed contract)

- Patient pays doctor ₹1,500 per consultation (offline)
- Platform takes 2% royalty = ₹30 per consultation
- Split: 0.67% × 3 team members = ₹10 per person per consultation
- Paid out annually at Indian financial year end (April 1 → March 31)
- Annual platform fee tiers (per doctor): 0–100 patients ₹2.5L | 101–200 ₹3L | 201–400 ₹4L | 400+ ₹5L
