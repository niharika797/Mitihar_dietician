      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-md flex flex-col max-h-[90vh]">
        ...
        <div className="overflow-y-auto p-5 flex-1">
          ...
          <div className="grid grid-cols-2 gap-3 mb-3">
            <div>
              <label className="block text-xs font-medium text-[#374151] mb-1.5">Meal Type</label>
              <select
                value={mealType}
          ...
          {/* Optional note */}
          <div>
            <label className="block text-xs font-medium text-[#374151] mb-1.5">Note for Patient (optional)</label>
            <input
              type="text"
              value={note}
    ...
    <div className="p-6">
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div
          key={recipe.id}
          className="bg-white border border-[#E5E7EB] rounded-lg p-4 hover:border-[#D1D5DB] transition-colors flex flex-col"
          >
